...
<body class="w3-metro-darken">
	<header class="w3-panel w3-center w3-opacity" style="padding-top:40px">
		...
		<hr>
		<a href="pages/howto.html" target="blank" class="w3-button w3-metro-orange w3-hover-yellow">HOW TO USE</a>
		</p>
	</header>
</body>
</html>
